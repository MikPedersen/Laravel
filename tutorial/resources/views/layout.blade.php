...
<div id="header-wrapper">
    <div id="header" class="container">
        ...
        <div id="menu">
            <ul>
                <!--- setup af menuen som flytter den blå markering ift hvad side der vises --->
                ...
                <li class="{{ Request::path() === 'articles' ? 'current_page_item' : '' }}"><a href="/articles" accesskey="4"
                                                                                              title="">Articles</a></li>
                <li class="{{ Request::path() === 'contacts' ? 'current_page_item' : '' }}"><a href="#" accesskey="5"
                                                                                               title="">Contact Us</a>
                </li>
            </ul>
        </div>
...
@yield('content')
<!--  Undermenuen vises på alle sider -->
